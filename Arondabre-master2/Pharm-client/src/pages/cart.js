...
const Cart = (props) => {
          ...
          <Grid container direction="row" spacing={2}>
            ...
            <Grid item sm={3}>
              <Paper
                ...
                style={{ backgroundColor: "#f0f0f0ff", marginBottom:20, marginLeft:30 }}
                elevation={4}
              >
                <div style={{ marginLeft: 20, marginRight: 20 }}>
                  ...
                  <Typography gutterBottom variant="h5" noWrap>
                    <div className={classes.spaceTypo}>
                      ...
                      <span>C$. {price + deliveryCharge}</span>
                    </div>
                    <br />
                  </Typography>
                  {step === 1 && (
  ...
  onSuccess={(response) => {
    ...
    history.push("/nextpage", { paymentId: response.razorpay_payment_id });
  }}
/>
